"""Settings panel for Flagsmith Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__flagsmith_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=flagsmith_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_flagsmith"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Flagsmith Settings & Accounts", level=2),
